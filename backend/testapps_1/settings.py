"""
Django settings for testapps_1 project.
...
WSGI_APPLICATION = 'testapps_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapps_1 API",
    "DESCRIPTION": "API documentation for testapps_1 App",
    "VERSION": "v1",
}
